...
// Console message
console.log('%c Welcome to Soledad Varady\'s Portfolio! ', 
    'background: linear-gradient(135deg, #06b6d4, #3b82f6); color: white; font-size: 16px; padding: 10px; border-radius: 5px;');
console.log('%c Interested in collaboration? Let\'s connect! ', 
...
// Cursor effect for featured project (optional enhancement)
